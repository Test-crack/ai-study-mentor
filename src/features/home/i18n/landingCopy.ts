...
const ML: LandingCopy = {
  ...
  pains: {
    ...
    cards: [
      {
        title: 'ബാൻഡ് സ്കോർ അനങ്ങുന്നില്ല — എന്താ കാരണംന്ന് ആർക്കുമറിയില്ല',
        description:
      ...
      {
        title: 'ക്ലാസ് എടുക്കാനല്ല, പേപ്പർ നോക്കാനാണ് അധ്യാപകരുടെ നേരം മുഴുവൻ',
        description:
      ...
      {
        title: 'പരീക്ഷയെത്തും മുൻപേ കുട്ടികൾ ഒന്നും പറയാതെ പാതിവഴിക്ക് നിർത്തും',
        description:
  ...
  features: {
    headline: 'ഒറ്റ പ്ലാറ്റ്ഫോം. മൂന്നു പേർക്കും ഗുണം.',
    subhead:
  ...
  contact: {
    eyebrow: 'ബന്ധപ്പെടാം',
    headline: 'ഒന്ന് വിളിക്കൂ,',
    headlineAccent: 'നമുക്ക് സംസാരിക്കാം.',
    subhead:
