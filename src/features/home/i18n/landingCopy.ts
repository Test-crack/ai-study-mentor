...
const ML: LandingCopy = {
  ...
  pains: {
    ...
    cards: [
      {
        title: 'ബാൻഡ് സ്കോർ ഒരിടത്ത് കുടുങ്ങി — കാരണം ആർക്കുമറിയില്ല',
        description:
      ...
      {
        title: 'പഠിപ്പിക്കാനല്ല, പേപ്പർ നോക്കാനാണ് അധ്യാപകരുടെ സമയം',
        description:
      ...
      {
        title: 'പരീക്ഷയ്ക്കു മുൻപേ കുട്ടികൾ ഒന്നും പറയാതെ കൊഴിഞ്ഞുപോകുന്നു',
        description:
  ...
  features: {
    headline: 'ഒരു പ്ലാറ്റ്ഫോം. മൂന്നു നേട്ടം.',
    subhead:
  ...
  contact: {
    eyebrow: 'ബന്ധപ്പെടാം',
    headline: 'നിങ്ങളുടെ വിളിക്കായി',
    headlineAccent: 'ഞങ്ങൾ കാത്തിരിക്കുന്നു.',
    subhead:
