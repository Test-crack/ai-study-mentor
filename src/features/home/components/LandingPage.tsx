...
<section className="relative min-h-[80vh] flex items-center pt-24 pb-10 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 via-white to-indigo-100 overflow-hidden ">
  ...
  className="bg-indigo-700 hover:bg-indigo-800 text-white px-10 py-7 h-auto transition-all duration-300 rounded-full shadow-[0_10px_20px_-5px_rgba(67,56,202,0.4)] hover:shadow-[0_20px_25px_-5px_rgba(67,56,202,0.4)] hover:-translate-y-1 active:scale-95 ring-offset-2 focus:ring-2 ring-indigo-500"
>
...
<Button
  ...
  variant="outline"
  onClick={() => navigate('/courses')}
  className="px-10 py-7 h-auto bg-white/40 backdrop-blur-md transition-all duration-300 rounded-full border-2 border-slate-200 hover:border-indigo-200 hover:bg-white hover:text-indigo-700 shadow-sm hover:shadow-md hover:-translate-y-1 active:scale-95"
>
