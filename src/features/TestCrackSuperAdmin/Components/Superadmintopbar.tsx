...
/>
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        {/* Notifications */}
        <button className="relative p-2 rounded-xl text-brand-text-mute hover:text-brand-teal-600 hover:bg-brand-bg-alt transition-colors">
          <Bell className="h-5 w-5" />
          <span className="absolute top-2 right-2.5 h-2 w-2 bg-brand-warm-danger rounded-full border-2 border-white"></span>
        </button>
        ...
        <div className="flex items-center gap-2.5">
          <div className="text-right hidden md:block">
            ...
            <p className="font-jetbrains text-[10px] font-semibold tracking-[0.12em] uppercase text-brand-text-mute mt-0.5">Super Admin</p>
          </div>
          <Avatar
