...
export const SpeedReadingWidget = () => {
  ...
  return (
    <Card className="border-none shadow-lg bg-gradient-to-br from-indigo-600 to-violet-700 dark:from-indigo-900 dark:to-violet-900 text-white rounded-2xl overflow-hidden relative transition-colors">
      {/* Decorative */}
      ...
      <CardContent className="p-6 sm:p-8 relative z-10 flex flex-col h-full justify-between">
        ...
        <div className="mt-6 flex items-center justify-between">
          <div className="text-center">
            <p className="text-xs text-indigo-200 uppercase tracking-wider font-semibold">Previous Best</p>
            <p className="text-2xl font-bold">240 <span className="text-sm font-normal text-indigo-200">WPM</span></p>
          </div>
          
          <Button 
            onClick={() => navigate('/assessment')}
            className="bg-white text-indigo-600 hover:bg-indigo-50 font-bold rounded-xl shadow-lg shadow-indigo-900/20 transition-all hover:-translate-y-0.5"
          >
