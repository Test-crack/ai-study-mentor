...
const SKILL_CONFIG: Record<Skill, { icon: React.ReactNode; color: string; bg: string; border: string }> = {
  ...
  Reading:   { icon: <BookOpen className="h-4 w-4" />,   color: "text-brand-blue-600", bg: "bg-brand-blue-50 dark:bg-brand-blue-500/10", border: "border-brand-blue-200 dark:border-brand-blue-500/30" },
...
const RESOURCE_CONFIG: Record<ResourceType, { icon: React.ReactNode; color: string; bg: string }> = {
  Video:    { icon: <Video className="h-3.5 w-3.5" />,      color: "text-brand-teal-700 dark:text-brand-teal-300",  bg: "bg-brand-teal-100 dark:bg-brand-teal-500/20" },
  ...
  Mock:     { icon: <FileText className="h-3.5 w-3.5" />,   color: "text-brand-blue-700 dark:text-brand-blue-300",  bg: "bg-brand-blue-100 dark:bg-brand-blue-500/20" },
};
            ...
            <div className="flex items-center gap-3 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl px-4 py-3 shadow-sm">
              <div className="relative h-10 w-10">
                <svg className="rotate-[-90deg]" width="40" height="40">
                  ...
                  <circle
                    cx="20" cy="20" r="15" fill="none" stroke="#12897C" strokeWidth="4"
                ...
                <span className="absolute inset-0 flex items-center justify-center text-[10px] font-black text-brand-teal-600">
        ...
        <button
          ...
          className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all duration-200 border
            ${suggestion.completed
              ...
              : "bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:bg-brand-teal-50 hover:text-brand-teal-600 hover:border-brand-teal-200 dark:hover:bg-brand-teal-500/10 dark:hover:text-brand-teal-400"
            }`}
        >
          {suggestion.completed
