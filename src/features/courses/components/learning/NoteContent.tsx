  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        isFocusMode 
          ? "bg-slate-900 border-brand-blue-500 shadow-[0_0_40px_-12px_rgba(147,51,234,0.5)] text-white" 
          : "bg-white border-blue-100 shadow-sm text-slate-900"
      )}>
        <div className="flex items-center gap-4">
          <div className={cn(
            "p-2.5 rounded-lg transition-all",
            isFocusMode ? "bg-brand-blue-500/20 text-brand-blue-300" : "bg-blue-100 text-blue-600"
          )}>
          ...
          <div>
            <span className={cn(
                ...
                isFocusMode ? "text-brand-blue-300" : "text-blue-600"
            )}>
              Reading Material
            </span>
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            ...
            className={cn(
              ...
              isFocusMode 
                ? "bg-brand-blue-600 border-brand-blue-400 text-white hover:bg-brand-blue-500 shadow-lg shadow-brand-blue-500/20" 
                : "bg-slate-50 border-slate-200 text-slate-600 hover:bg-white hover:border-brand-blue-400 hover:text-brand-blue-600"
            )}
          >
      ...
      <article className={cn(
        ...
        "prose-code:bg-gray-100 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:font-mono prose-code:text-brand-blue-700 prose-code:before:content-none prose-code:after:content-none",
        "prose-pre:bg-gray-900 prose-pre:text-gray-100 prose-pre:rounded-lg prose-pre:p-4 prose-pre:overflow-x-auto",
        "prose-ul:my-4 prose-ul:list-disc prose-ul:pl-6",
        "prose-ol:my-4 prose-ol:list-decimal prose-ol:pl-6",
        "prose-li:text-gray-700 prose-li:mb-2",
        "prose-blockquote:border-l-4 prose-blockquote:border-brand-blue-300 prose-blockquote:bg-brand-blue-50 prose-blockquote:py-2 prose-blockquote:px-4 prose-blockquote:italic prose-blockquote:text-gray-700",
        ...
        <ReactMarkdown
          components={{
            ...
            code: ({ className, children, ...props }) => {
              ...
              if (isInline) {
                return (
                  <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm font-mono text-brand-blue-700" {...props}>
                    {children}
                  </code>
                );
              }
            ...
            blockquote: ({ children }) => (
              <blockquote className="border-l-4 border-brand-blue-400 bg-brand-blue-50 py-3 px-4 my-4 rounded-r-lg">
                {children}
              </blockquote>
            ),
            ...
            a: ({ href, children }) => (
              <a
                ...
                className="text-brand-blue-600 hover:text-brand-blue-800 hover:underline"
              >
                {children}
              </a>
            ),
