...
const CoursesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      {/* Hero Section */}
      <div className="bg-indigo-700 dark:bg-indigo-900 text-white transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white dark:text-slate-100">
            Learn without limits
          </h1>
          <p className="text-xl text-purple-100 dark:text-purple-200 max-w-2xl">
